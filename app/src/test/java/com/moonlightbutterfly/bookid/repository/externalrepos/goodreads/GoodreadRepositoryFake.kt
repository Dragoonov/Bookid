...
class GoodreadRepositoryFake : ExternalRepository {
    ...
    override suspend fun loadSearchedBooks(query: String?, page: Int): List<Book> = listOf(
        Book(page, query, null, "01.01.1970", 4.5, null),
        Book(page, query, null, "02.01.1970", 4.5, null),
        Book(page, query, null, "03.01.1970", 4.5, null),
        Book(page, query, null, "04.01.1970", 4.5, null)
    )
